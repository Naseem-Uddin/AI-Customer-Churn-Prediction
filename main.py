...
def make_predictions(input_df, input_dict):
    ...
    probabilities = {
        ...
        'XGBoost Feature Engineered Model': xgboost_featuredEngineered_model.predict_proba(input_df)[0][1],
...
def explain_prediction(probability, input_dict, surname):
    prompt = f"""You are an expert data scientist at a bank, where you specialize in interpreting and explaing prediction of machine larning models.
    ...
    - If the customer has over a 40% risk of chrurning, generate a 3 sentence explanation of why they are risk of churning. 

    - If the customer has less than a 40% risk of churning, generate a 3 sentence explanation of why they are not at risk of churning.
    ...
    Don't mention the probability of churning or the machine learning model or say anything like "Based on the machine learning mode's prediction and top 10 most important features, just explain the prediction.
    """
...
def generate_email(probability, input_dict, explanation, surname):
    prompt = f"""You are a manager at MY Bank. You are responsible for ensuring customers stay with the bank and are incentivized with various offers. 
    ...
    Generate an email to the customer based on their information asking to stay if they are at risk of churning, or offering them incentives so that they become more loyal to the bank.

    Make sure to list out a set of incentives based on their information, in bullet point format. Don't ever mention the probability of churning, or the machine learning model to the customer. 
    """
...
if selected_customer_option:
    ...
    with col2:
        ...
        is_active_member = st.checkbox(
            'IsActiveMember', value=bool(selected_customer['IsActiveMember']))
    ...
    explanation = explain_prediction(avg_prob, input_dict,
